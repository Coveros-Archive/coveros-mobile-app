...
public class RestClient {
    ...
    public static enum REST_CLIENT_VERSIONS {V0, V1, V2}
    public static final String PARAMS_ENCODING = "UTF-8";

    protected static final String REST_API_ENDPOINT_URL_V0 = "https://www3.dev.secureci.com/";
    protected static final String REST_API_ENDPOINT_URL_V1 = "https://www3.dev.secureci.com/wp-json/wp/v1/";
    protected static final String REST_API_ENDPOINT_URL_V2 = "https://www3.dev.secureci.com/wp-json/wp/v2/";
    ...
    public RestClient(RequestQueue queue, REST_CLIENT_VERSIONS version) {
        ...
        } else if (version == REST_CLIENT_VERSIONS.V1) {
