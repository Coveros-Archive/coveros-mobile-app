...
public class OAuth {
    ...
    public static final String AUTHORIZE_ENDPOINT = "https://www3.dev.secureci.com/oauth/authorize";
    private static final String AUTHORIZED_ENDPOINT_FORMAT = "%s?client_id=%s&redirect_uri=%s&response_type=code";

    public static final String TOKEN_ENDPOINT = "https://www3.dev.secureci.com/oauth/token";
